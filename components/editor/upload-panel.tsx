    ...
    return (
        <div className="h-full flex items-center justify-center p-6 lg:p-12">
            <div
                {...getRootProps()}
                className={cn(
                    "w-full max-w-lg aspect-square border-2 border-dashed rounded-none transition-transform transition-shadow duration-300 flex flex-col items-center justify-center text-center cursor-pointer focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-foreground/20",
                    isDragActive
